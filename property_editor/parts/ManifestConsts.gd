...
const CONFIG_NODES = {
	"bool":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/bool.tscn"),
	"int":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/int.tscn"),
	"float":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/float.tscn"),
	"string":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/string.tscn"),
	"optionbutton":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/optionbutton.tscn"),
	"input":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/input.tscn"),
	"action":preload("res://addons/DVTools/property_editor/modules/manifests/inputboxes/config_parts/action.tscn"),
}
