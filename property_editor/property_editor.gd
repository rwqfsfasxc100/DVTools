...
var property_nodes = {
	"null":load("res://addons/DVTools/property_editor/property_containers/null.tscn"),
	"bool":load("res://addons/DVTools/property_editor/property_containers/bool.tscn"),
	"int":load("res://addons/DVTools/property_editor/property_containers/int.tscn"),
	"float":load("res://addons/DVTools/property_editor/property_containers/float.tscn"),
	"string":load("res://addons/DVTools/property_editor/property_containers/string.tscn"),
	"Vector2":load("res://addons/DVTools/property_editor/property_containers/vec2.tscn"),
	"Vector3":load("res://addons/DVTools/property_editor/property_containers/vec3.tscn"),
	"Rect2":load("res://addons/DVTools/property_editor/property_containers/rect2.tscn"),
	"Transform2D":load("res://addons/DVTools/property_editor/property_containers/transform2d.tscn"),
	"Color":load("res://addons/DVTools/property_editor/property_containers/color.tscn"),
	"Dictionary":load("res://addons/DVTools/property_editor/property_containers/dict.tscn"),
	"Array":load("res://addons/DVTools/property_editor/property_containers/array.tscn"),
	"PoolByteArray":load("res://addons/DVTools/property_editor/property_containers/poolbytearray.tscn"),
	"PoolIntArray":load("res://addons/DVTools/property_editor/property_containers/poolintarray.tscn"),
	"PoolRealArray":load("res://addons/DVTools/property_editor/property_containers/poolrealarray.tscn"),
	"PoolStringArray":load("res://addons/DVTools/property_editor/property_containers/poolstringarray.tscn"),
	"PoolVector2Array":load("res://addons/DVTools/property_editor/property_containers/poolvector2array.tscn"),
	"PoolVector3Array":load("res://addons/DVTools/property_editor/property_containers/poolvector3array.tscn"),
	"PoolColorArray":load("res://addons/DVTools/property_editor/property_containers/poolcolorarray.tscn"),
}
