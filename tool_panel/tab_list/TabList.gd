...
var supported_driver_files = {
	...
	"SLOT_TAGS.gd":"res://addons/DVTools/tool_panel/panels/SLOT_TAGS.gd/SlotTagPanel.tscn",
	"SLOT_ORDER.gd":"res://addons/DVTools/tool_panel/panels/SLOT_ORDER.gd/OrderContainer.tscn",
